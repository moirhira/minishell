...
SRC = 	src/main.c src/utils/main_utils.c src/utils/utils.c src/utils/utils_2.c src/utils/setup_signals.c src/utils/display_error.c \
		...
		src/parser/parsing/parser.c src/parser/parsing/parser_utils.c src/parser/parsing/parser_utils_1.c  \
		src/parser/parsing/parse_heredocs_1.c src/parser/parsing/parse_heredocs_2.c src/parser/parsing/validate_syntaxe.c\
		...
		src/executor/builtins/builtin_exit.c src/executor/builtins/builtin_exit_helper.c src/executor/builtins/builtin_export.c src/executor/builtins/builtin_env.c src/executor/builtins/builtin_unset.c\
	  	src/executor/setup_redirections.c src/executor/externals/externals.c src/executor/externals/find_command_in_path.c src/executor/externals/find_cmd_inpath_helper.c   \
